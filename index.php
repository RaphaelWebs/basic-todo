    ...
    <div class="main-section">
        ...
        <div class="add-section">
            <form action="functions/add.php" method="POST" autocomplete="off">
                ...
                <button class="add-button" type="submit" aria-label="Add note"> <svg viewBox="0 96 960 960" aria-hidden="true">
                ...
                <ul class="todo-list">
                    <?php while ($todo = $todos->fetch(PDO::FETCH_ASSOC)) { ?>
                        <li class="todo-item">
                            ...
                            <span id="<?php echo $todo['id']; ?>" class="remove-to-do" aria-label="Delete item"><svg viewBox="0 96 960 960" aria-hidden="true">
